...
public class HibernateRunner {
    ...
    public static void main(String[] args){
        ...
        aSillyHibernateUseExample.modifyUser1();
        aSillyHibernateUseExample.modifyUser2();
        aSillyHibernateUseExample.addSharedPhoneNumber1();
        aSillyHibernateUseExample.addSharedPhoneNumber2();
        aSillyHibernateUseExample.deleteAddedUsers1();
    ...
    private void addNewUsers() {
        ...
        User abloomfield = new User();
        abloomfield.setUname("Alex");
        abloomfield.setPword("Hello123");
        ...
        System.out.println("anotherUser generated ID is: " + abloomfield.getId());
    ...
    private void modifyUser2() {
         ...
         * get a single User instance from the database.
         */
        Query singleUserQuery = session.createQuery("select u from User as u where u.uname='Alex'");
        User abloomfield = (User)singleUserQuery.uniqueResult();
        /*
         * change the user name for the Java instance
         */
        abloomfield.setUname("abloomfield");
        /*
         * call the session merge method for the User instance in question.  This tells the database that the instance is ready to be permanently stored.
         */
        session.merge(abloomfield);
    ...
    private void addSharedPhoneNumber1() {
        Session session = theHibernateUtility.getCurrentSession();
        Transaction transaction = session.beginTransaction();
        /*
    ...
    private void addSharedPhoneNumber2() {
        Session session = theHibernateUtility.getCurrentSession();
        Transaction transaction = session.beginTransaction();
        /*
         * get one User instances from the database using HQL.  This is NOT SQL.  It is object based.
         */
        Query abloomfieldQuery = session.createQuery("select u from User as u where u.uname='abloomfield'");
        User abloomfieldUser = (User)abloomfieldQuery.uniqueResult();

        /*
         * create a PhoneNumber instance
         */
        PhoneNumber sharedPhoneNumber = new PhoneNumber();
        sharedPhoneNumber.setPhone("(619)212-9898");

       /*
        * add the shared phone number to the abloomfieldUser
        */

        Set<PhoneNumber> abloomfieldPhoneNumbers = abloomfieldUser.getPhoneNumbers();
        abloomfieldPhoneNumbers.add(sharedPhoneNumber);
              /*
        * inform the database that the phone number should be ready for permanent storage.
        */
        session.save(sharedPhoneNumber);
    ...
    private void deleteAddedUsers1() {
        Session session = theHibernateUtility.getCurrentSession();
        Transaction transaction = session.beginTransaction();
